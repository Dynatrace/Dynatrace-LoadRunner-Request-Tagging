...
/*******************************************************************************/
	...
	addDynaTraceHeader("NA=07_BrowserReport_BALS_S02_View;PC=submitReportRequestPage.do");
	...
	addDynaTraceHeader("NA=07_BrowserReport_BALS_S02_View;PC=execSyncReport.do");
