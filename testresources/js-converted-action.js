...
/*Correlation comment - Do not change!  Original value='vkvklff9' Name ='ice.view' Type ='ResponseBased'*/
	...
	addDynatraceHeaderTest("TSN=customer login;PC=orange.jsf;jsessionid=2848D1DAE693DC0BC8A43DCB73B54AB8.jvmRoute-8280;SI=LoadRunner;LSN=script name;");
	web.submitData(
		{
	...
	addDynatraceHeaderTest("TSN=customer login;PC=orange.jsf;SI=LoadRunner;LSN=script name;");
	web.submitData(
		{
			name : 'orange.jsf', 
	...
	addDynatraceHeaderTest("TSN=customer login;PC=orange.jsf_2;SI=LoadRunner;LSN=script name;");
	web.submitData(
		{
			name : 'orange.jsf_2', 
			action : 'http://localhost:8079/orange.jsf', 
	...
	addDynatraceHeaderTest("TSN=search journey;PC=orange.jsf_3;SI=LoadRunner;LSN=script name;");
	web.submitData(
		{
			name : 'orange.jsf_3', 
			action : 'http://localhost:8079/orange.jsf', 
	...
	lr.thinkTime(6);
	addDynatraceHeaderTest("TSN=search journey;PC=orange.jsf_4;SI=LoadRunner;LSN=script name;");
	web.submitData(
		{
			name : 'orange.jsf_4', 
			action : 'http://localhost:8079/orange.jsf', 
	...
	addDynatraceHeaderTest("TSN=search journey;PC=orange.jsf_5;SI=LoadRunner;LSN=script name;");
	web.submitData(
		{
			name : 'orange.jsf_5', 
			action : 'http://localhost:8079/orange.jsf', 
	...
	addDynatraceHeaderTest("TSN=search journey;PC=orange.jsf_6;SI=LoadRunner;LSN=script name;");
	web.submitData(
		{
			name : 'orange.jsf_6', 
			action : 'http://localhost:8079/orange.jsf', 
	...
	addDynatraceHeaderTest("TSN=search journey;PC=orange.jsf_7;SI=LoadRunner;LSN=script name;");
	web.submitData(
		{
			name : 'orange.jsf_7', 
			action : 'http://localhost:8079/orange.jsf', 
	...
	addDynatraceHeaderTest("TSN=search journey;PC=CalculateRecommendations_2;SI=LoadRunner;LSN=script name;");
	web.customRequest(
		{
	...
	addDynatraceHeaderTest("TSN=search journey;PC=orange.jsf_8;SI=LoadRunner;LSN=script name;");
	web.submitData(
		{
			name : 'orange.jsf_8', 
			action : 'http://localhost:8079/orange.jsf', 
...
/*Correlation comment - Do not change!  Original value='vkvklffa' Name ='ice.view_1' Type ='ResponseBased'*/
	...
	addDynatraceHeaderTest("TSN=search journey;PC=orange-booking-review.jsf;SI=LoadRunner;LSN=script name;");
	web.url(
		{
	...
	addDynatraceHeaderTest("TSN=book journey;PC=orange-booking-review.jsf_2;SI=LoadRunner;LSN=script name;");
	web.submitData(
		{
...
/*Correlation comment - Do not change!  Original value='vkvklffb' Name ='ice.view_2' Type ='ResponseBased'*/
	...
	addDynatraceHeaderTest("TSN=book journey;PC=orange-booking-payment.jsf;SI=LoadRunner;LSN=script name;");
	web.url(
		{
	...
	addDynatraceHeaderTest("TSN=book journey;PC=orange-booking-payment.jsf_2;SI=LoadRunner;LSN=script name;");
	web.submitData(
		{
	...
	lr.thinkTime(7);
	addDynatraceHeaderTest("TSN=book journey;PC=orange-booking-payment.jsf_3;SI=LoadRunner;LSN=script name;");
	web.customRequest(
		{
...
//	web.regFind("Finish");
	...
	addDynatraceHeaderTest("TSN=book journey;PC=orange-booking-finish.jsf_2;SI=LoadRunner;LSN=script name;");
	web.submitData(
		{
	...
	addDynatraceHeaderTest("TSN=book journey;PC=orange-booking-finish.jsf_3;SI=LoadRunner;LSN=script name;");
	web.url(
		{
