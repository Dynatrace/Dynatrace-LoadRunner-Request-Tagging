...
public final class Constants {
	...
	public static final Set<String> C_KEYWORDS = Sets.newHashSet("web_browser", "web_button", "web_check_box",
			...
			"web_custom_request");
	public static final Set<String> C_CLICK_AND_SCRIPT_KEYWORDS = Sets.newHashSet("web_browser", "web_button",
